...
<div class="ph">
  ...
  <div class="ph-center">${lbBand}<div><div class="pt">${esc(projectName)}</div><div class="ps">Material Planer · Touring Production · ◆ v0.6.20</div></div></div>
...
<script>window.onload=()=>setTimeout(()=>window.print(),500);<\/script>
  ...
  if(!win){ toast('Pop-up blockiert — bitte Popups für diese Seite erlauben und erneut versuchen.', true); return; }
